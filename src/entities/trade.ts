...
export class Trade {
  ...
  public static exactIn(route: Route, amountIn: CurrencyAmount): Trade {
    const chainId: ChainId | undefined = amountIn instanceof TokenAmount ? amountIn.token.chainId : ChainId.ETHEREUM
  ...
  public static exactOut(route: Route, amountOut: CurrencyAmount): Trade {
    const chainId: ChainId | undefined = amountOut instanceof TokenAmount ? amountOut.token.chainId : ChainId.ETHEREUM
