...
import { FACTORY_ADDRESS } from '..'
import { InsufficientInputAmountError } from '../errors'
import { computePairAddress, Pair, currentTestChain } from './pair'

describe('computePairAddress', () => {
  it('should correctly compute the pool address', () => {
    const tokenA = new Token(currentTestChain, '0xe687b0a94c3a20540552d981cd311a6812759df8', 18, 'USDT', 'USD Coin')
    ...
    expect(result).toEqual('0x17398F4101dac7c9C1d637b1139EEA9D3d700250')
  })
  it('should give same result regardless of token order', () => {
    const USDC = new Token(currentTestChain, '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', 18, 'USDC', 'USD Coin')
    const DAI = new Token(currentTestChain, '0x6B175474E89094C44Da98b954EedeAC495271d0F', 18, 'DAI', 'DAI Stablecoin')
    let tokenA = USDC
    let tokenB = DAI
